...
<body>
	...
	<div class="container">
		...
		<button class="btn btn-success btn-circle btn-lg" onclick="tambah_buku()" data-toggle="tooltip" data-placement="top" title="Tambah Buku!" ><i class="glyphicon glyphicon-plus"></i></button>
		<br>
		<br>
	...
	<table id="id_table" class="table table-stripped table-bordered" >
		...
		foreach($tbbuku as $buku){
			...
			<tr>
				...
				<td>
					<button class="btn btn-warning" onclick="edit_buku(<?php echo $buku->id_buku; ?>)" data-toggle="tooltip" data-placement="top" title="Edit Buku!"><i class="glyphicon glyphicon-pencil"></i></button>
					<button class="btn btn-danger" onclick="hapus_buku(<?php echo $buku->id_buku; ?>)" data-toggle="tooltip" data-placement="top" title="Hapus Buku!"><i class="glyphicon glyphicon-remove"></i></button>
				</td>
			</tr>
      ...
      <form action="#" id="form" class="form-horizontal">
      	...
      	<div class="form-body">
      		<div class="form-group">
      			...
      			<div class="col-md-9">
      				<input type="text" name="penulis" placeholder="ISBN Buku" class="form-control" >
       			</div>     			
      		</div>
      	</div>
